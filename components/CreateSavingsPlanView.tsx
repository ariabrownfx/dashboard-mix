            ...
            <div className="space-y-6 animate-in fade-in">
                ...
                <div className="bg-slate-900 text-white p-5 rounded-xl shadow-lg flex justify-between items-center">
                    ...
                    <div className="text-right">
                        <p className="text-xs text-slate-400 font-bold uppercase mb-1">Est. Return</p>
                        <p className="text-xl font-bold">₦{((Number(targetAmount) || 0) * (currentRate/100) * (tenor/365)).toLocaleString(undefined, { maximumFractionDigits: 0 })}</p>
                    </div>
                </div>
            </div>
        )}
